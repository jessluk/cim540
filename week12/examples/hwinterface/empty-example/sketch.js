...
function preload() {
  ...
  imageArray.push(loadImage('assets/show.png'));
  imageArray.push(loadImage('assets/hide.png'));
  imageArray.push(loadImage('assets/taylor.png'));


  soundFile = loadSound('assets/getaway.mp3');
